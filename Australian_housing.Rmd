...
```
Figure \@ref(fig:property-type) illustrates that __houses are the most abundantly available in the market with 441 listed properties followed by units at 230 listings and then apartments with 212 listings. The __remaining property types are observed to constitute a small portion of the available listings__.
