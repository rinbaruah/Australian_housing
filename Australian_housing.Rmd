...
After removing the outlier, let us try to visualise the plot for prices against property types.
...
pl3 <-
  ggplot(
    ...
    aes(x = factor(property_type,level = level_order), y = new_price, fill = property_type)) + geom_boxplot() + labs(x = "Property type", 
                                                                    y =" Number of available properties") + ggtitle("Price dsitribution of properties") +        theme_classic() +
      theme(
